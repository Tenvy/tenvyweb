...
export default function Home() {
  return (
    <>
      <Navbar />
      <Sidebar/>
      <div className={`container mx-auto flex justify-center items-center h-screen px-5 ${styles.animateFadeIn}`}>
        <svg width="800" height="454" viewBox="0 0 440 94" fill="none" xmlns="http://www.w3.org/2000/svg">
